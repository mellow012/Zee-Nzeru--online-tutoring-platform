...
import { Loader2, DollarSign, CheckCircle, AlertCircle, Clock } from 'lucide-react';
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {payout.status === 'payout_requested' ? (
                          <Badge className="bg-amber-100 text-amber-800 border-none animate-pulse"><AlertCircle className="w-3 h-3 mr-1"/> Withdrawal Requested</Badge>
                        ) : payout.status === 'ready_for_payout' ? (
                          <Badge className="bg-indigo-100 text-indigo-800 border-none"><CheckCircle className="w-3 h-3 mr-1"/> Ready (No Request)</Badge>
                          ...
                          <Badge variant="outline" className="text-slate-500 bg-slate-50 border-none"><Clock className="w-3 h-3 mr-1"/> Held in Escrow</Badge>
                        )}
                      </div>
                    </div>
                  </div>
