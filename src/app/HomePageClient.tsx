...
export function HomePageClient({ topTutors, publicReviews }: { topTutors: TutorCard[], publicReviews: any[] }) {
  ...
  return (
    <>
      ...
      <LandingPage onLogin={openLogin} onSignup={openSignup} topTutors={topTutors} publicReviews={publicReviews} />
