...
const ROLE_CARDS: {
  ...
  },
  {
    ...
    icon:     GraduationCap,
    label:    "I'm a Tutor",
    desc:     'Share your expertise and earn',
    perks:    ['Flexible schedule', 'Guaranteed payouts', 'Interactive classroom'],
      ...
      <AnimatePresence mode="wait" custom={dir}>
        ...
        {step === 1 && (
          <motion.div key="step1" custom={dir} variants={slide} initial="enter" animate="center" exit="exit">
            ...
            >
              {role === 'tutor' ? 'Apply to Teach' : role === 'student' ? 'Continue as Student' : 'Continue'}
